 ...
 */
Posicionable.prototype.getPosition = function() {
  return {
    x: this._posX,
    y: this._posY
  };
 ...
 */
Posicionable.prototype.setPosition = function(newPosition) {
 ...
 */
Posicionable.prototype.getId = function() {
  return this._id;
}

 ...
 */
function Shot(shot, flyHigh = false) {
  Positionable.call(this, shot.x, shot.y);
  this._rotation = blurAngle(shot.r, SHOT_PRECISION);
  this._speedX = Math.cos(degToRad(this._rotation)) * SHOT_SPEED;
  this._speedY = Math.sin(degToRad(this._rotation)) * SHOT_SPEED;
  this._destroy = false;
  this._force = 3;
  this._flyHigh = flyHigh;

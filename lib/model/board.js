 ...
 */
Board.prototype.isOccupied = function(spot) {
  if (spot.x < 0 || spot.x >= BOARD_WIDTH) return true;
  if (spot.y < 0 || spot.y >= BOARD_HEIGHT) return true;
  if (this._stage[spot.x][spot.y] !== null) return true;
  return false;
}

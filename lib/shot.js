...
Shot.prototype = Object.create(Posicionable.prototype);
Shot.prototype.constructor = Player;
 ...
 */
Shot.prototype.checkBoard(board) {
  return {
    x: 0,
    y: 0
  };
 ...
 */
Shot.prototype.checkPlayer(player) {
 ...
 */
Shot.prototype.update() {
  var targetX += this._speedX * this._speed;
  var targetY += this._speedY * this._speed;
